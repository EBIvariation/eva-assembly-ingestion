...
class AssemblyIngestionJob(AppLogger):
    ...
    def process_all_assemblies(self, source_assemblies_and_taxonomies, resume):
        ...
        release_directory = os.path.join(base_directory, f'release{self.release_version}')
        taxonomy_directory = os.path.join(release_directory, str(self.source_taxonomy))
